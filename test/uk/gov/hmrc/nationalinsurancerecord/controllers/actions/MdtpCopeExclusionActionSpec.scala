...
class MdtpCopeExclusionActionSpec extends CopeExclusionActionSpec {

  val mockStatePensionConnector: MdtpStatePensionConnector = mock[MdtpStatePensionConnector]

  override def fakeApplication(): Application = GuiceApplicationBuilder()
    .overrides(
       bind[MdtpStatePensionConnector].toInstance(mockStatePensionConnector)
    )
    .build()
  ...
  override def actionUnderTest: TestHarness = new TestHarness(app.injector.instanceOf[MdtpCopeExclusionAction])
}
